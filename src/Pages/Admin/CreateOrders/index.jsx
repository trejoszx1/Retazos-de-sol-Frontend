...
const CreateOrders = () => {
  const [tasks, setTasks] = useState([
    { id: 'task-1', content: 'Hacer la compra' },
    { id: 'task-2', content: 'Estudiar React' },
    // ...otras tareas
  ]);

  const handleDragEnd = (result) => {
    // Lógica para actualizar el orden de las tareas
    // result.draggableId, result.source.index, result.destination.index, etc.
  };
  return (
    <Layout>
  ...
  <div className="space-y-12">
    <div className="border-b border-gray-900/10 pb-12">
      ...
      <p className="mt-1 text-sm leading-6 text-gray-600">This inidmation will be displayed publicly so be careful what you share.</p>

      <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        <div className="sm:col-span-4">
          <label id="username" className="block text-sm font-medium leading-6 text-gray-900">Username</label>
          <div className="mt-2">
        ...
        <div className="col-span-full">
          <label id="about" className="block text-sm font-medium leading-6 text-gray-900">About</label>
          <div className="mt-2">
        ...
        <div className="col-span-full">
          <label id="photo" className="block text-sm font-medium leading-6 text-gray-900">Photo</label>
        ...
        <div className="col-span-full">
          <label id="cover-photo" className="block text-sm font-medium leading-6 text-gray-900">Cover photo</label>
          <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
            <div className="text-center">
              ...
              <div className="mt-4 flex text-sm leading-6 text-gray-600">
                <label id="file-upload" className="relative cursor-pointer rounded-md bg-white font-semibold text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500">
    ...
    <div className="border-b border-gray-900/10 pb-12">
      <h2 className="text-base font-semibold leading-7 text-gray-900">Personal Inidmation</h2>
      <p className="mt-1 text-sm leading-6 text-gray-600">Use a permanent address where you can receive mail.</p>

      <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        <div className="sm:col-span-3">
          <label id="first-name" className="block text-sm font-medium leading-6 text-gray-900">First name</label>
          <div className="mt-2">
        ...
        <div className="sm:col-span-3">
          <label id="last-name" className="block text-sm font-medium leading-6 text-gray-900">Last name</label>
          <div className="mt-2">
        ...
        <div className="sm:col-span-4">
          <label id="email" className="block text-sm font-medium leading-6 text-gray-900">Email address</label>
          <div className="mt-2">
        ...
        <div className="sm:col-span-3">
          <label id="country" className="block text-sm font-medium leading-6 text-gray-900">Country</label>
          <div className="mt-2">
        ...
        <div className="col-span-full">
          <label id="street-address" className="block text-sm font-medium leading-6 text-gray-900">Street address</label>
          <div className="mt-2">
        ...
        <div className="sm:col-span-2 sm:col-start-1">
          <label id="city" className="block text-sm font-medium leading-6 text-gray-900">City</label>
          <div className="mt-2">
        ...
        <div className="sm:col-span-2">
          <label id="region" className="block text-sm font-medium leading-6 text-gray-900">State / Province</label>
          <div className="mt-2">
        ...
        <div className="sm:col-span-2">
          <label id="postal-code" className="block text-sm font-medium leading-6 text-gray-900">ZIP / Postal code</label>
          <div className="mt-2">
          ...
          <div className="mt-6 space-y-6">
            <div className="relative flex gap-x-3">
              ...
              <div className="text-sm leading-6">
                <label id="comments" className="font-medium text-gray-900">Comments</label>
            ...
            <div className="relative flex gap-x-3">
              ...
              <div className="text-sm leading-6">
                <label id="candidates" className="font-medium text-gray-900">Candidates</label>
                <p className="text-gray-500">Get notified when a candidate applies id a job.</p>
              </div>
            </div>
            <div className="relative flex gap-x-3">
              <div className="flex h-6 items-center">
              ...
              <div className="text-sm leading-6">
                <label id="offers" className="font-medium text-gray-900">Offers</label>
        ...
        <fieldset>
          ...
          <div className="mt-6 space-y-6">
            <div className="flex items-center gap-x-3">
              ...
              <label id="push-everything" className="block text-sm font-medium leading-6 text-gray-900">Everything</label>
            </div>
            <div className="flex items-center gap-x-3">
              ...
              <label id="push-email" className="block text-sm font-medium leading-6 text-gray-900">Same as email</label>
            </div>
            <div className="flex items-center gap-x-3">
              ...
              <label id="push-nothing" className="block text-sm font-medium leading-6 text-gray-900">No push notifications</label>
            </div>
          </div>
        </fieldset>
      </div>
